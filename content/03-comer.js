/* GERADO de content/site/03-comer.json por scripts/build-content.mjs — NÃO EDITE.
  ...
  "blocks": [
    {
      ...
      "intro": "São quatro refeições por dia, servidas em horário combinado. A comunidade come junta.",
      "items": [
        {
          "name": "Café da manhã",
          "time": "6h às 8h"
    ...
    },
    {
      ...
      "label": "O que se come",
      "title": "O que se come",
      "intro": "Comida caseira, entre a cozinha japonesa e a brasileira, com o que a horta deu no dia.",
      "columns": 3,
      "items": [
        {
          "meta": "Pão ou arroz",
    ...
    },
    {
      ...
      "items": [
        "Como Yuba não é um hotel, fica difícil atender restrições para vegetarianos, veganos ou pessoas com intolerâncias. Não conseguimos fazer pratos especiais.",
        "Mas temos uma boa seleção variada no dia a dia, e podemos tirar dúvidas sobre o preparo e os temperos. Nunca tivemos ninguém que passasse por dificuldade ou ficasse com fome durante a estadia."
      ]
    }
  ]
});
