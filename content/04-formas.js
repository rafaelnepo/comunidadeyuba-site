/* GERADO de content/site/04-formas.json por scripts/build-content.mjs — NÃO EDITE.
   Fontes e decisões desta seção: content/site/FONTES.md */
YUBA.section({
  "id": "formas",
  "eyebrow": "Como vir",
  "title": "Como funciona para visitar?",
  "lead": "Passar o dia, ficar hospedado, ou vir trabalhar com a gente. Cada uma pede um combinado diferente.",
  "source": "plan.txt L137–141, L143–216, L218–224, L227–237",
  "blocks": [
    {
      "type": "cards",
      "label": "As três formas",
      "intro": "Cada um chega de um jeito, e todos cabem. Tem quem venha passar um dia, quem fique uns dias e entre no ritmo da casa, e quem chegue com vontade de pôr a mão na terra e aprender fazendo. Veja qual se parece com você. O combinado a gente acerta depois.",
      "columns": 3,
      "items": [
        {
          "meta": "Sem dormir",
        ...
        },
        {
          ...
          "defs": [
            {
              "t": "Acomodação",
              "d": "coletiva, separada por gênero"
            },
            {
              "t": "Quem procuramos",
              "d": "mochileiros e aventureiros"
            }
          ],
      ...
      "items": [
        {
          ...
          "body": [
            "<strong>2 dias / 1 noite</strong> para uma visita de final de semana. <strong>7 dias / 6 noites</strong> para imersão, quando a rotina da comunidade deixa de ser paisagem e vira convivência."
          ]
        },
        {
    ...
    },
    {
      ...
      "wide": true,
      "items": [
        "Não conseguimos reembolsar o valor da reserva, então pedimos que cancelamentos sejam confirmados com 2 a 3 dias de antecedência. Se ninguém aparecer na data combinada, pedimos o pagamento de uma diária completa por pessoa cancelada, para cobrir o que já foi preparado para receber vocês."
      ]
    },
    {
      "type": "split",
    ...
    },
    {
      ...
      "right": {
        ...
        "defs": [
          {
            "t": "Internet",
            "d": "WiFi rápido em toda a comunidade. Para reuniões online há espaço no Museu Kitahara Wako e na Biblioteca, com fibra ótica por cabo e satélite como backup. Dá para trabalhar enquanto se aproveita a comunidade."
          },
          {
            "t": "Pets",
            "d": "Não recomendamos trazer. Temos cachorros e gatos soltos, não podemos nos responsabilizar por acidentes, e há risco de pulgas e carrapatos no campo."
          }
        ]
      }
    }
